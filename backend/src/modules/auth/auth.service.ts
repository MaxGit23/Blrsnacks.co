...
export class AuthService {
    ...
    private async generateAndPersistTokens(
        ...
        const accessExpiresIn = this.configService.get<number>('JWT_EXPIRES_IN_SECONDS', 900);
        const refreshExpiresIn = this.configService.get<number>('JWT_REFRESH_EXPIRES_IN_SECONDS', 604800);
