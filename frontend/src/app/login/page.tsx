        ...
        <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4 py-12 animate-fade-in">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-stone-900 font-display">Welcome Back</h1>
                    <p className="text-stone-500 mt-2 font-body">Sign in to continue ordering fresh snacks</p>
                </div>
                ...
                <p className="text-center text-sm text-text-secondary mt-6">
                    New to BLR Snacks?{' '}
                    <Link href="/register" className="font-semibold text-red-600 hover:text-red-700 transition-colors cursor-pointer">
                        Create an account
                    </Link>
                </p>
            </div>
